...
const SOCIAL_API_URL = API_URL || 'https://script.google.com/macros/s/AKfycbzo-QbWaEOlPHZPhKAktdoH8TzYNFPB6Pwl6Redw8kGLHbaA08ZPvDBQOEsg6ahGUf/exec';
...
async function saveSocialFromModal(targetPid) {
  ...
  try {
    console.log('💾 სოციალური მედიის შენახვა...');
    ...
    console.log('✅ API გამოძახება დასრულდა');
